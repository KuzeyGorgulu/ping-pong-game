// Acces to canvas and context
const cvs = document.getElementById("game");
const ctx = cvs.getContext("2d");

// Drawing background (func)
const drawRect = (x, y, w, h, color) => {
  ctx.fillStyle = color;
  ctx.fillRect(x, y, w, h);
};

// Drawing a circle (func)
...
const render = () => {
  ...
  //drawRect(ball.x,ball.y,ball.r,ball.color,ball.speed,ball.velocityX,ball.velocityY,ball.stop)
};
